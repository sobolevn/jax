...
ALL_CONVERTERS = [
    ...
    Converter(
        name='jax2tf_noxla_tfjs', convert_fn=jax2tfjs, compare_numerics=False),
    Converter(name='jax2tf_noxla_tflite', convert_fn=jax2tflite),
    Converter(
        name='jax2tf_noxla_tflite+flex',
